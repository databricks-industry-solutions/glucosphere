  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
      ...
      <Link to="/firmware-lifecycle" className="group border border-amber-500/40 rounded-lg p-5 bg-slate-900/30 hover:bg-slate-900/60 hover:border-amber-400/70 transition-colors flex flex-col h-full">
        ...
        <h3 className="text-base font-semibold text-slate-200 mt-3" style={{ fontFamily: '"Avenir Next", Avenir, "Segoe UI", system-ui, sans-serif' }}>Firmware Lifecycle Timeline</h3>
        ...
        <span className="text-xs text-amber-300 font-mono mt-auto pt-3 inline-block group-hover:translate-x-0.5 transition-transform">Open view →</span>
      </Link>

      {/* ③ Assess — LIVE */}
      <Link to="/population-risk" className="group border border-rose-500/40 rounded-lg p-5 bg-slate-900/30 hover:bg-slate-900/60 hover:border-rose-400/70 transition-colors flex flex-col h-full">
        ...
        <h3 className="text-base font-semibold text-slate-200 mt-3" style={{ fontFamily: '"Avenir Next", Avenir, "Segoe UI", system-ui, sans-serif' }}>Population Risk Stratification</h3>
        ...
        <span className="text-xs text-rose-300 font-mono mt-auto pt-3 inline-block group-hover:translate-x-0.5 transition-transform">Open view →</span>
      </Link>
    </div>
  );
}
