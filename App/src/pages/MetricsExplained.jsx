            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 font-mono">
                  Generated by the{' '}
                  {workspaceHost ? (
                    <a href={`${workspaceHost}/jobs`} target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">
                      glucosphere-full-setup-*
                    </a>
                  ) : (
                    <span className="text-cyan-400">glucosphere-full-setup-*</span>
                  )}
                  {' '}job (the bundle-target-suffixed full setup workflow) — open your workspace's Jobs UI and search for the name. PNG is read live from UC Volume
