...
export const TOUR_STEPS_INTERACTIVE = [
  ...
  { route: '/diabetes-coach', selector: '[data-tour="coach-risk"]', title: '③ Assess — per patient', interactive: true, body: 'Down to one patient: their near-term (15/30-min) glucose forecast from the XGBoost model. ▶ Try it: search PSEUDO_0000257 — its device displayed a false low (~40 mg/dL) while true glucose was actually ~87; the ⚠ False-low banner warns that treating that fake hypo would push a fine patient HIGH.' },
