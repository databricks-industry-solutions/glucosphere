...
- **Pseudo-patient generation (clean data)**: `04_pseudo_data_forecast_modeling.py` creates pseudo-patients from baseline windows and validates that their glucose distribution looks realistic.
