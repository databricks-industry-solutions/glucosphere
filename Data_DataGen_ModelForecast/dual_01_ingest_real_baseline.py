...
# Mode dispatch — table mode is stubbed until Commit C.3
if BASELINE_SOURCE == "real_from_table":
    raise NotImplementedError(
        "real_from_table mode is not yet implemented (plan's Commit C.3). "
        "For now use BASELINE_SOURCE=real_from_source to download HUPA-UCM, "
        "or set baseline_source=synthetic at the bundle level to skip this notebook."
    )
